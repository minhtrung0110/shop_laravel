...
<div class="container p-t-100">
    ...
    <div class="bread-crumb flex-w p-l-25 p-r-15 p-t-30 p-lr-0-lg ">
        ...
        <a href="/products/{{$product->menu->id}}-{{\Str::slug($product->menu->name)}}.html" class="stext-109 cl8 hov-cl1 trans-04">
            {{$product->menu->name}}
            <i class="fa fa-angle-right m-l-9 m-r-10" aria-hidden="true"></i>
        </a>
...
<section class="sec-relate-product bg0 p-t-45 p-b-105">
    <div class="container">
        ...
        <div class="wrap-slick2">
            <div class="slick2">
                @foreach($relative_product as $more)
                <div class="item-slick2 p-l-15 p-r-15 p-t-15 p-b-15">
                    <!-- Block2 -->
                    <div class="block2">
                        <div class="block2-pic hov-img0">
                            <img src="{{$more->thumb }}" alt="IMG-PRODUCT">
                        ...
                        <div class="block2-txt flex-w flex-t p-t-14">
                            <div class="block2-txt-child1 flex-col-l ">
                                <a href="/detail-product/{{$more->id}}-{{\Str::slug($more->name,'-')}}.html" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
                                    {{$more->name}}
                                </a>

                                <span class="stext-105 cl3">
                                    {{\App\Helpers\Helper::price($more->price,$more->price_sale)}}  VNĐ
                                </span>
                            </div>
